...
public class MovimientoNavesSpawn : MonoBehaviour
{
    ...
    void InitialPopulation()
    {
        ...
        for(int i=0; i<ship_limit; i++)
        {
            ...
            MovimientoNaves ship_script = AddShip(position);
    ...
    MovimientoNaves AddShip(Vector3 position)
    {
        ...
        MovimientoNaves ship_script = new_ship.GetComponent<MovimientoNaves>();
